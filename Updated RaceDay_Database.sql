...
(OrganiserId, Name, Description, EventDate, Location, EventType, Status)
VALUES
(1,
...
(EventId, Name, DistanceKm, MaxParticipants, EntryFee, MinAge, MaxAge)
VALUES
(1, '10 km Open', 10.00, 500, 180.00, 16, NULL),
(1, '21 km Half Marathon', 21.10, 300, 280.00, 18, NULL),
(2, '5 km Family Walk', 5.00, 400, 80.00, 10, NULL),
(2, '10 km Challenge Walk', 10.00, 250, 120.00, 16, NULL),
(3, '40 km Social Ride', 40.00, 350, 220.00, 16, NULL),
(3, '80 km Challenge Ride', 80.00, 250, 350.00, 18, NULL);
GO
...
(ParticipantId, EventId, CategoryId, Status, BibNumber)
VALUES
(3, 1, 1, 'Confirmed', 'JR001'),
(4, 1, 2, 'Confirmed', 'JR002'),
(3, 2, 3, 'Confirmed', 'PW001'),
(4, 3, 5, 'Confirmed', 'CC001');
GO
...
VALUES
(1, '00:58:42', 12, 'Finished'),
(2, '01:52:10', 8, 'Finished'),
(3, NULL, NULL, 'DNS');
GO
...
(EventId, RouteName, DistanceKm, SurfaceType, MapUrl, ElevationGainM)
VALUES
(1,
 'Joburg Central Loop',
 10.00,
...
(EventId, ForecastDate, TemperatureC, Condition, WindSpeedKmh)
VALUES
(1, '2026-10-18', 21.50, 'Partly cloudy', 14.00),
(2, '2026-11-08', 23.00, 'Sunny', 10.00),
(3, '2026-11-22', 19.50, 'Cloudy', 22.00);
GO
/* =========================
CHECK THE DATA
========================= */
